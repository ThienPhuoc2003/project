...
import { ImageIcon, FileTextIcon, GanttChartIcon, MoreVertical, TrashIcon, TextIcon } from "lucide-react";
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={async () => {
              ...
              toast({ variant: "default", title: "File Deleted", description: "Your file is now gone from the system" });
  ...
  return (
    <Card>
      <CardHeader className="relative">
        <CardTitle className="flex gap-2">{icon}{file.name}</CardTitle>
      ...
      <CardFooter className='flex justify-center'>
         <a href={getFileUrl(file.fileId)} download={file.name}>
